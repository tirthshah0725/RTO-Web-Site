<?php
    ...
    $sname = $_SESSION['name'];
		...
		if(isset($_POST['submit']))
		{
            ...
            $query = "insert into learning_lis_data values('$fname','$mname','$lname','$uname','$pass','$bdate','$phone','$email','$address','$state','$city','$eq','$ltype','$status',' ');";
...
<style>
   ...
   .content{
        ...
        flex-direction: column;
        align-items: center; */
        background: url("../image/keyboard.jpg") no-repeat center center/cover;
        color: white;
