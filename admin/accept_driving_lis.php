...
if(isset($_POST['submit']))
{
    ...
    $query = "update driving_lis_data set Status='$status',Action_Date='$date' where Username = '$uname'; ";
...
<div class="part2">    
    ...
    <div class="content">
        <div class="hed">
            <h1>Driving Licence Application</h1>
        </div>
        <div class="details">
...
$query = "select * from driving_lis_data where Status='pendding';";
