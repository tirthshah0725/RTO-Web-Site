...
<div class="part2">    
    ...
    <ul>
        ...
        <div class="content">
            ...
            <p>City Name:</p>
            <input type="text" name="newcity"class="itext" placeholder="Enter new city Name"><br>
            
            <p>Confirm City Name:</p>
            <input type="text" name="confirmcity"class="itext" placeholder="Enter confirm City Name"><br>
