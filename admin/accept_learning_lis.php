...
{
    $status = $_POST['lis_status'];
    $date = $_POST['action_date'];
    $uname = $_POST['uname'];

    $query = "update learning_lis_data set Status='$status',Action_Date='$date' where Username = '$uname'; ";
...
<body>
    ...
    <div class="part2">    
        ...
        <div class="content">
            <div class="hed">
                <h1>Learning Licence Application</h1>
            </div>
            <div class="details">
...
$query = "select * from learning_lis_data where Status='pendding';";
